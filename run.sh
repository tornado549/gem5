...
sudo build/X86/gem5.opt configs/deprecated/example/se.py --cmd=$EXEC --cpu-type=X86TimingSimpleCPU --l2cache --l3cache --l1d_size=32kB --l1i_size=32kB --l2_size=1024kB --l3_size=16MB --caches --mem-size=20GB
